...
<html>
<head>
	<title>Job Types - The Jobs</title>
...
<body class="sidebar-dark">
	...
	<div class="main-wrapper">
		...
		<div class="page-content">
	        ...
	        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
		          <div>
		            <h4 class="mb-3 mb-md-0">Job Types</h4>
		          </div>
            </div>
			        ...
			        <div class="card">
			            <div class="card-body p-2 p-md-3">
			                ...
			                <div class="text-center float-md-right">
			                    <a href="JobTypeControllerServlet?command=SHOW-ADDDATA" class="btn btn-outline-primary btn-icon-text">
			                ...
			                <div id="divRecords" class="m-0 p-0 mt-2">
								<div class="table-responsive">
									<table class="table table-centered table-nowrap table-striped">
										<thead>
											<tr>
												<th class="d-none">Job Type ID</th>
												<th>Job Type Name</th>
												<th style="width:70px;">Action</th>
											</tr>
										</thead>
										<tbody id="tblBody">
											<c:forEach  items="${JobType_lists}" var="JobType_lists">
													
												<tr id="row_${JobType_lists.job_type_specialization_id}">
													<td class="d-none">${JobType_lists.job_type_specialization_id}</td>
													<td>${JobType_lists.job_type_name}</td>
													<td>
									                    <a href="JobTypeControllerServlet?command=SHOW-UPDATE&id=${JobType_lists.job_type_specialization_id}" class="table-icon text-primary"><i class="mdi mdi-square-edit-outline"></i></a>
									            
									                	<a href="javascript:void(0);" onclick="ConfirmDelete('${JobType_lists.job_type_specialization_id}')" class="table-icon text-danger"> <i class="mdi mdi-delete"></i></a>
									                </td>
												</tr>
											</c:forEach>
										</tbody>
 ...
 $(document).ready(function () {
	...
	var DeleteRecord = function (){
           ...
           var url = 'JobTypeControllerServlet';
