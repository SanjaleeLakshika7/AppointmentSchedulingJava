        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="resources/assetconsultant/img/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase">Jobs Consultancy</h5>
                            <h1 class="display-1 text-white mb-md-4">We Provide Solution On Your Jobs</h1>
                            <a href="AppointmentControllerServlet?command=SHOW-ADDDATA" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Get Appointment</a>
    ...
    <div class="container-fluid bg-secondary p-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                ...
                <a href="AppointmentControllerServlet?command=SHOW-ADDDATA" class="btn btn-primary py-md-3 px-md-5 rounded-pill">Get Appointment</a>
            </div>
            <div class="col-lg-6">
