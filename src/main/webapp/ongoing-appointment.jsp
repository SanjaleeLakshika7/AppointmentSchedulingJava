 ...
 <%
	...
	<div class="main-wrapper">
		...
		<jsp:include page="shared/sidebar.jsp">
			<jsp:param name="OnGoing" value="active"/>
		</jsp:include>
		...
		<div class="page-content">
	        ...
	        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
		          <div>
		            <h4 class="mb-3 mb-md-0"> On Going Appointments Details </h4>
		          </div>
            </div>
										...
										<tbody id="tblBody">
											<c:forEach  items="${appointmentDetails_lists}" var="appointmentDetails_lists">
												...
												<tr id="row_${appointmentDetails_lists.appointment_id}">
													...
													<td>
								                    <a href="javascript:void(0);" onclick="ConfirmBtnBooking('${appointmentDetails_lists.appointment_id}')" data-toggle="tooltip" title="" class="table-icon text-primary"><i class="mdi mdi-square-edit-outline"></i>Complete</a>
