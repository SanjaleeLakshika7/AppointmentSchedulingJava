...
<body class="sidebar-dark">
	...
	<div class="main-wrapper">
		...
		<div class="page-content">
	        ...
	        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
		          <div>
		            <h4 class="mb-3 mb-md-0">Employees</h4>
		          </div>
            </div>
			        ...
			        <div class="card">
			            <div class="card-body p-2 p-md-3">
			                ...
			                <div class="text-center float-md-right">
			                    <a href="EmployeeControllerServlet?command=SHOW-ADDDATA" class="btn btn-outline-primary btn-icon-text">
									...
									<table class="table table-centered table-nowrap table-striped">
										...
										<tbody id="tblBody">
											<c:forEach  items="${employee}" var="employee">
												...
												<tr id="row_${employee.employee_id}">
										            ...
										            <td>${employee.email}</td>
													 ...
													 <td>
									                    <a href="EmployeeControllerServlet?command=SHOW-UPDATE&id=${employee.employee_id}" class="table-icon text-primary"><i class="mdi mdi-square-edit-outline"></i></a>
									            
									                	<a href="javascript:void(0);" onclick="ConfirmDelete('${employee.employee_id}')" class="table-icon text-danger"> <i class="mdi mdi-delete"></i></a>
									                </td>
												</tr>
											</c:forEach>
										</tbody>
 ...
 $(document).ready(function () {
	...
	var DeleteRecord = function (){
           ...
           var url = 'EmployeeControllerServlet';
