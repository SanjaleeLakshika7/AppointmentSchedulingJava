...
<html>
<head>
	<title>Appointments - The Jobs</title>
	...
	<div class="main-wrapper">
		...
		<div class="page-content">
	        ...
	        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
		          <div>
		            <h4 class="mb-3 mb-md-0"> Pending Appointments Details </h4>
		          </div>
            </div>
										...
										<tbody id="tblBody">
											<c:forEach  items="${appointmentDetails_lists}" var="appointmentDetails_lists">
												...
												<tr id="row_${appointmentDetails_lists.appointment_id}">
													...
													<td>
								                    <a href="javascript:void(0);" onclick="ConfirmBtnBooking('${appointmentDetails_lists.appointment_id}')" data-toggle="tooltip" title="" class="table-icon text-primary"><i class="mdi mdi-square-edit-outline"></i>Accept</a>
								                   	<a href="javascript:void(0);" onclick="ConfirmBtnReject('${appointmentDetails_lists.appointment_id}')" class="table-icon text-danger"> <i class="mdi mdi-delete"></i>Reject</a>
		  ...
		  <div class="modal fade" id="ConfirmBooking" role="dialog" aria-hidden="true">
			    <div class="modal-dialog modal-dialog-centered">
			        <div class="modal-content">
			            ...
			            <div class="modal-body">
			                <p>Are you sure you want to Confirm  this Appointment of Customer?</p>
